...
\begin{table}[h]
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
      ...
      \hline
      (CC) & {\it lm\/} & $P_2$ & $S_1$ & 0.1 & $g_0$ & 2.21 & 2 & 7 \\
      \hline
      (CC) & {\it lm\/} & $P_2$ & $S_1$ & 0.1 & $g_3$ & 2.14 & 1 & 2 \\
      \hline
      (CC) & {\it lm\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_0$ & 2.21 & 2 & 7 \\
      \hline
      (CC) & {\it lm\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_3$ & 2.14 & 1 & 2 \\
      \hline
      (CC) & {\it lm\/} & $P_2$ & $N_{kon}$ & 0.1 & $g_0$ & 2.66 & 2 & 7 \\
      \hline
      (CC) & {\it lm\/} & $P_2$ & $N_{kon}$ & 0.1 & $g_3$ & 2.14 & 1 & 2 \\
      \hline
      (CC) & {\it sqp\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_0$ & 2.14 & 9 & 10 \\
      \hline
    \end{tabular}
...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
      ...
      \hline
      (DC) & {\it lm\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_0$ & 2.99 & 20 & 42 \\
      \hline
      (DC) & {\it lm\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_{0.4,42.5}$ & 2.76 & 20 & 40 \\
      \hline
      (DC) & {\it sqp\/} & $P_0$ & $S_{0.5}$ & 0.1 & $g_0$ & 3.3 & 18 & 205 \\
      \hline
      (DC) & {\it sqp\/} & $P_0$ & $S_{0.5}$ & 0.1 & $g_{0.4,42.5}$ & 2.75 & 10 & 123 \\
      \hline
      (DC) & {\it sqp\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_0$ & 3.28 & 9 & 105 \\
      \hline
      (DC) & {\it sqp\/} & $P_2$ & $S_{0.5}$ & 0.1 & $g_{0.4,42.5}$ & 2.75 & 10 & 136 \\
      \hline
    \end{tabular}
